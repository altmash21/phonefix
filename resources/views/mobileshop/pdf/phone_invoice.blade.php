    ...
    <table class="table header-table">
        <tr>
            <td style="width: 58%; vertical-align: top;">
                <div class="company-name">{{ setting('company.name', 'MobiTrack Retail Store') }}</div>
    ...
    <table class="table items-table">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right font-mono">{{ number_format($sale->sale_price / 1.18, 2) }}</td>
                <td class="text-right font-mono">{{ number_format($sale->sale_price / 1.18, 2) }}</td>
            ...
            <td style="width: 45%; vertical-align: top;">
                <table class="summary-table">
                    <tr>
                        ...
                        <td style="text-align: right;" class="font-mono">{{ number_format($sale->sale_price / 1.18, 2) }}</td>
                    </tr>
                    @if($sale->bill_type === 'gst')
                    <tr>
    ...
    <table class="table footer-table">
        <tr>
            ...
            <td style="width: 40%; vertical-align: top; text-align: right;">
                <div style="font-size: 10px; font-weight: bold; color: #111827;">For {{ setting('company.name', 'MobiTrack Retail Store') }}</div>
