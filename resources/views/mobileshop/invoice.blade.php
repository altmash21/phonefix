...
@php
    ...
    $waMsg = "🧾 *" . ($isGstBill ? 'TAX INVOICE & RECEIPT' : 'ESTIMATE & RETAIL BILL') . "*\n";
    $waMsg .= "🏪 *{$storeName}*\n";
    $waMsg .= "━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
    ...
    if ($isGstBill) {
        ...
        $waMsg .= "• *GST (18%):* ₹" . number_format($totalTaxAmount, 2) . " (CGST ₹" . number_format($cgstAmount, 2) . " + SGST ₹" . number_format($sgstAmount, 2) . ")\n";
    }
